    ...
    <div className="border-b border-neutral-900 pb-12 lg:mb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
        {[ 
          {
            icon: "🧑‍💻", 
            title: "Passion for AI Innovation", 
            text: "Driven by a strong passion for artificial intelligence, I am deeply fascinated by its potential to revolutionize industries and improve lives. I am eager to explore its many applications, from machine learning and generative AI to solving real-world challenges, and to play a part in advancing this exciting field."
          },
          {
            icon: "👥", 
