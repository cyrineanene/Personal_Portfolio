  ...
  return (
    <nav className="mb-20 flex items-center justify-between py-6">
      ...
      <div className="flex space-x-6 text-lg">
        ...
        <a href="#aboutme" className="hover:text-purple-400">About Me</a>
        ...
        <a href="#volunteering" className="hover:text-purple-400">Volunteering</a>
      </div>
      <div className="m-8 flex items-center justify-center gap-4 text-2xl">
        <a
          href="https://www.linkedin.com/in/cyrine-anene-6b79b0245"
          target="_blank"
        ...
        <a
          href="https://github.com/cyrineanene"
          target="_blank"
          rel="noopener noreferrer"
        >
          <FaGithub />
